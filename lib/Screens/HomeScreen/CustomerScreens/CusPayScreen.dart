...
class CusPayScreen extends StatefulWidget {
  const CusPayScreen({Key? key}) : super(key: key);

  @override
  State<CusPayScreen> createState() => _CusPayScreenState();
}

class _CusPayScreenState extends State<CusPayScreen> {
  @override
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('Give Payment', style: GoogleFonts.cabin(color: constants.kPrimary,fontSize: 30),),
                    Stack(
                      children: [
                        Container(
                          height: 40,
